module.exports = {
  ...
  messages: {
    ...
    'app.header.menu.pro.v4': 'EZ Design Pro',
    'app.header.menu.pro.components': 'EZ Design Pro Components',
    'app.header.menu.charts': 'EZ Design Charts',
    ...
    'app.home.introduce':
      'Fluorite EZVIZ enterprise product business design, is committed to everyone to enjoy a secure intelligent life.',
    ...
    'app.home.design-values-description':
      'This is EZ Design\'s internal standard for evaluating design quality. Based on the assumption that "everyone is pursuing happiness at work", we have added the two values of "Meaningfulness" and "Growth" on the basis of "Certainty" and "Naturalness" to guide each designer towards better judgment and decision-making.',
    ...
    'app.home.product-mobile-slogan': 'Mobile UI components with EZ Design',
    ...
    'app.footer.awesome': 'Awesome EZ Design',
    'app.footer.course': 'EZ Design Practical Tutorial',
    ...
    'app.footer.ezd-library': 'Axure library',
