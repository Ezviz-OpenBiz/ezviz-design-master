module.exports = {
  ...
  messages: {
    ...
    'app.header.menu.pro.v4': 'Evv Design Pro',
    'app.header.menu.pro.components': 'Evv Design Pro Components',
    'app.header.menu.charts': 'Evv Design Charts',
    ...
    'app.home.design-values-description':
      'This is Evv Design\'s internal standard for evaluating design quality. Based on the assumption that "everyone is pursuing happiness at work", we have added the two values of "Meaningfulness" and "Growth" on the basis of "Certainty" and "Naturalness" to guide each designer towards better judgment and decision-making.',
    ...
    'app.home.product-mobile-slogan': 'Mobile UI components with Evv Design',
    ...
    'app.footer.awesome': 'Awesome Evv Design',
    'app.footer.course': 'Evv Design Practical Tutorial',
    ...
    'app.footer.zhihu': 'Evv Design Blog',
