module.exports = {
  ...
  messages: {
    ...
    'app.home.introduce': '萤石设计体系/Web平台标准化设计组件及规范',
    ...
    'app.home.design-values-description':
      '这是 EZ Design 评价设计好坏的内在标准。基于「每个人都追求快乐工作」这一假定，我们在「确定性」和「自然」的基础上，新增「意义感」和「生长性」两个价值观，指引每个设计者做更好地判断和决策。',
    ...
    'app.footer.ezd-library': 'Axure 部件库',
