...
describe('Drawer', () => {
  it('render right MultiDrawer', () => {
    ...
    const translateX = wrapper.find('.ezd-drawer.test_drawer').get(0).props.style.transform;
  ...
  it('render left MultiDrawer', () => {
    ...
    expect(translateX).toEqual('translateX(180px)');
    expect(wrapper.find('#two_drawer_text').exists()).toBe(true);
    wrapper.find('.Two-level .ezd-drawer-close').simulate('click');
  ...
  it('render MultiDrawer is child in unmount', () => {
    ...
    let translateX = wrapper.find('.ezd-drawer.test_drawer').get(0).props.style.transform;
    expect(translateX).toEqual(undefined);
    wrapper.find('button#open_two_drawer').simulate('click');
    translateX = wrapper.find('.ezd-drawer.test_drawer').get(0).props.style.transform;
    expect(translateX).toEqual('translateY(180px)');
    expect(wrapper.find('#two_drawer_text').exists()).toBe(true);
  });
