...
describe('Modal.hook', () => {
  ...
  it('hooks support context', () => {
    ...
    expect(wrapper.find('.ezd-btn').length).toBeTruthy();
    expect(wrapper.find('.ezd-modal-body').length).toBeTruthy();
  ...
  it('context support config direction', () => {
    ...
    wrapper.find('button').simulate('click');
    expect(wrapper.find('.ezd-input-rtl').length).toBeTruthy();
  });
  ...
  it('hooks modal should trigger onCancel', () => {
    ...
    wrapper.find('.ezd-modal-confirm-btns .ezd-btn').first().simulate('click');
    expect(cancelCount).toEqual(1); // click cancel btn, trigger onCancel

    wrapper.find('.open-hook-modal-btn').simulate('click');
    wrapper.find('.ezd-modal-wrap').simulate('click');
  ...
  it('update before render', () => {
    ...
    expect(wrapper.find('.ezd-modal-confirm-title').text()).toEqual('Bamboo');
  });
  ...
  it('destroy before render', () => {
    ...
    expect(wrapper.exists('.ezd-modal-confirm-title')).toBeFalsy();
  });
});
