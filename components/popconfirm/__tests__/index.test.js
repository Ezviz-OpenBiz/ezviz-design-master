...
describe('Popconfirm', () => {
  ...
  it('should show overlay when trigger is clicked', async () => {
    ...
    expect(popup.className).toContain('ezd-popover-placement-top');
  ...
  it('should be controlled by visible', () => {
    ...
    expect(ref.current.getPopupDomNode().className).not.toContain('ezd-popover-hidden');
  ...
  it('should trigger onConfirm and onCancel', () => {
    ...
    triggerNode.simulate('click');
    popconfirm.find('.ezd-btn-primary').simulate('click');
    expect(confirm).toHaveBeenCalled();
    expect(onVisibleChange).toHaveBeenLastCalledWith(false, eventObject);
    triggerNode.simulate('click');
    popconfirm.find('.ezd-btn').at(0).simulate('click');
