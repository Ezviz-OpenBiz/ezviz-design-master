...
describe('TextArea', () => {
  ...
  describe('should support showCount', () => {
    it('maxLength', () => {
      ...
      const textarea = wrapper.find('.ezd-input-textarea');
    ...
    describe('emoji', () => {
      it('should minimize value between emoji length and maxLength', () => {
        ...
        const textarea1 = wrapper1.find('.ezd-input-textarea');
    ...
    it('className & style patch to outer', () => {
      ...
      // Inner
      expect(wrapper.find('.ezd-input').hasClass('bamboo')).toBeFalsy();
      expect(wrapper.find('.ezd-input').props().style.background).toBeFalsy();
    });
  ...
  it('should support size', async () => {
    ...
    expect(wrapper.find('textarea').hasClass('ezd-input-lg')).toBe(true);
    expect(wrapper.render()).toMatchSnapshot();
  });
...
describe('TextArea allowClear', () => {
  ...
  it('onChange event should return HTMLTextAreaElement', () => {
    ...
    // Reset
    wrapper.find('.ezd-input-clear-icon').first().simulate('click');
    isNativeElement();
  });
