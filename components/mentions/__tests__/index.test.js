...
describe('Mentions', () => {
  ...
  it('focus', () => {
    ...
    expect(wrapper.find('.ezd-mentions').hasClass('ezd-mentions-focused')).toBeTruthy();
    expect(onFocus).toHaveBeenCalled();

    wrapper.find('textarea').simulate('blur');
    jest.runAllTimers();
    wrapper.update();
    expect(wrapper.find('.ezd-mentions').hasClass('ezd-mentions-focused')).toBeFalsy();
  ...
  it('loading', () => {
    ...
    expect(wrapper.find('li.ezd-mentions-dropdown-menu-item').length).toBe(1);
    expect(wrapper.find('.ezd-spin').length).toBeTruthy();
  });
