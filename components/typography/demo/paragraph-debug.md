...
ReactDOM.render(
  <>
    ...
    <Paragraph>
      After massive project practice and summaries, EZ Design, a design language for background
      applications, is refined by EZ UED Team, which aims to
      <Text strong>
    ...
    <Paragraph>
      ...
      EZ Design。基于<Text mark>『确定』和『自然』</Text>
