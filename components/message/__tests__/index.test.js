...
describe('message', () => {
  ...
  it('should be able to hide manually', () => {
    ...
    expect(document.querySelectorAll('.ezd-message-notice').length).toBe(2);
    hide1();
    jest.runAllTimers();
  ...
  it('should be able to destroy globally', () => {
    ...
    message.info('whatever', 0);
    expect(document.querySelectorAll('.ezd-message').length).toBe(1);
    expect(document.querySelectorAll('.ezd-message-notice').length).toBe(2);
    message.destroy();
    expect(document.querySelectorAll('.ezd-message').length).toBe(0);
    expect(document.querySelectorAll('.ezd-message-notice').length).toBe(0);
  });
  ...
  it('trigger onClick method', () => {
    ...
    mount(<Test />);
    expect(document.querySelectorAll('.ezd-message-notice').length).toBe(1);
    document.querySelectorAll('.ezd-message-notice')[0].click();
  ...
  it('should allow custom icon', () => {
    ...
    expect(document.querySelectorAll('.ezdicon-smile').length).toBe(1);
  });

  it('should have no icon', () => {
    message.open({ content: 'Message', icon: <span /> });
    expect(document.querySelectorAll('.ezd-message-notice .ezdicon').length).toBe(0);
  });
