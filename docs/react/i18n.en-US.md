...
The default language of `@ezviz/evvd@1.x` is currently English. If you wish to use other languages, follow the instructions below.

## ConfigProvider

`@ezviz/evvd` provides a React Component [ConfigProvider](/components/config-provider) for configuring antd locale text globally.

```jsx
import { ConfigProvider } from '@ezviz/evvd';
import frFR from '@ezviz/evvd/lib/locale/fr_FR';
